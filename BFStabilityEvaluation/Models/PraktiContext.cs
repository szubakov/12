    ...
    public partial class PraktiContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Parameter>().HasData(
                ...
                new Parameter { ParameterId = 18, Name = "Расход природного газа, м3/т чугуна", Alias = "Gas consumption", Unit = "м3/т чугуна", MinValue = 100, MaxValue = 150 },
                new Parameter { ParameterId = 19, Name = "Содержание кислорода в дутье, %", Alias = "HotBlastO2", Unit = "%", MinValue = 21, MaxValue = 30 },
                new Parameter { ParameterId = 20, Name = "Температура горячего дутья, °С", Alias = "TempHotBlast", Unit = "°С", MinValue = 900, MaxValue = 1300 },
                new Parameter { ParameterId = 21, Name = "Средняя температура колошникового газа, °С", Alias = "TempKolGaz", Unit = "°С", MinValue = 80, MaxValue = 350 },
                ...
                new Parameter { ParameterId = 29, Name = "Теоретическая температура горения, °С", Alias = "Theoretical  temperature", Unit = "°С", MinValue = 1900, MaxValue = 2100 },
                new Parameter { ParameterId = 30, Name = "Содержание в чугуне Si, %", Alias = "Si content in cast iron", Unit = "%", MinValue = 0.4, MaxValue = 1.0 },
                new Parameter { ParameterId = 31, Name = "Индекс низа, доли", Alias = "Index of the bottom temperature ", Unit = "доли", MinValue = 0.45, MaxValue = 0.55 },
                new Parameter { ParameterId = 32, Name = "Индекс верха, доли", Alias = "Index of the top of the temperature ", Unit = "доли", MinValue = 0.297, MaxValue = 0.363 },
                ...
                new Parameter { ParameterId = 36, Name = "Коэффициент распределения серы, доли", Alias = "Sulfur distribution coefficient", Unit = "°доли", MinValue = 0.3, MaxValue = 0.5 },
                ...
                new Parameter { ParameterId = 42, Name = "Перепад давления «фурмы – колошник», атм", Alias = "P drop tuyere - top", Unit = "атм", MinValue = 1, MaxValue = 2 },
