...
namespace BFStabilityEvaluation.Migrations
{
    ...
    [Migration("20220727184552_TableKriteriaNameNull")]
    partial class TableKriteriaNameNull
    {
            ...
            modelBuilder.Entity("BFStabilityEvaluation.Models.Parameter", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ParameterId = 33,
                            Alias = "Basicity of final slag (CaO/(SiO2)",
                            MaxValue = 0.0,
                            MinValue = 0.0,
                        ...
                        {
                            ParameterId = 34,
                            Alias = "Basicity of final slag (CaO+MgO)/(SiO2)",
                            MaxValue = 0.0,
                            MinValue = 0.0,
                        ...
                        {
                            ParameterId = 35,
                            Alias = "Basicity of final slag (CaO+MgO)/(SiO2+Al2O3)",
                            MaxValue = 0.0,
                            MinValue = 0.0,
